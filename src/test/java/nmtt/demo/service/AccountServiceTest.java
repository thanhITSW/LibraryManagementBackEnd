...
//        when(passwordEncoder.matches(changePasswordRequest.getOldPassword(), account1.getPassword())).thenReturn(true);
...
//
//        // Then
//        assertEquals("encodedNewPassword", account1.getPassword());
//        verify(accountRepository, times(1)).save(account1);
//    }
//
//    @Test
...
//
//        when(accountRepository.findById(any())).thenReturn(Optional.of(account1));
//        when(passwordEncoder.matches(changePasswordRequest.getOldPassword(), account1.getPassword())).thenReturn(false);
//
//        // When & Then
